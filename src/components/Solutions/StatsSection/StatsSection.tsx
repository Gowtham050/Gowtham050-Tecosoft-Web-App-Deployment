...
function StatsGrid() {
  ...
  return (
    <div ref={gridRef} className="grid grid-cols-1 sm:grid-cols-2 gap-8 md:gap-12 lg:gap-16 xl:gap-20 w-full lg:max-w-[650px] relative z-10 justify-center sm:justify-items-start">
  ...
  return (
    <div className="absolute bottom-0 left-0 w-full h-20 md:h-[100px] z-0">
      <div className="scale-y-[-100%] w-full h-full">
        <img alt="" className="w-full h-full object-cover pointer-events-none" src={statsContent.bottomGradient} />
      </div>
    </div>
  );
}
...
export function StatsSection() {
  return (
    <div className="bg-white relative w-full min-h-[500px] md:min-h-[600px]" data-name="Stats">
      <div className="flex flex-col items-center overflow-clip w-full h-full">
          <BackgroundPattern />
        <div className="box-border flex flex-col lg:flex-row items-start lg:items-center justify-between gap-12 md:gap-16 lg:gap-20 py-12 md:py-16 lg:py-20 px-6 md:px-12 lg:px-16 xl:px-24 relative w-full max-w-[1400px] mx-auto min-h-[500px] md:min-h-[600px]">
          <BottomGradient />
          <SectionHeader />
          <StatsGrid />
        </div>
