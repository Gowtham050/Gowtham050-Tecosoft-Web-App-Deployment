...
export default function ModelGif({ currentProduct, hoveredProduct }: any) {
    return (
        <div
            className={`hidden lg:flex fixed top-0 left-0 right-0 bottom-0 z-[100] ${hoveredProduct && currentProduct ? " w-full h-full opacity-100 duration-500" : "opacity-0 w-[20%] h-[20%] duration-300"} m-auto items-center justify-center pointer-events-none transition-all ease-out overflow-hidden bg-[#3b83f129] backdrop-blur-2xl modalgif`}
            style={{
