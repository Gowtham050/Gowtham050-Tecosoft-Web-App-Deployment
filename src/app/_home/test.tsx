...
const Industry = () => {
    ...
    cards: [
      {
        ...
        position: "lg:top-[204px] lg:left-[1%]",
        width: "lg:w-[300px] 2xl:w-[400px]",
        border: false,
        animationDelay: "0s",
      },
      {
        ...
        position: "lg:top-[76px] lg:right-[1%]",
        width: "lg:w-[300px] 2xl:w-[400px]",
        border: false,
        animationDelay: "1s",
      },
  ...
  return (
    <div className="flex flex-col lg:min-h-[1000px] items-center p-6  px-4 sm:px-6 md:px-8 xl:px-[116px] relative self-stretch w-full overflow-hidden bg-gradient-to-br from-[#00BCEF] via-[#0066B2] to-[#002363]">
      ...
      <div className="flex flex-col lg:flex-wrap w-full items-center justify-center gap-5 sm:gap-6 lg:gap-0 relative pt-6 lg:pt-0 ">
        ...
        {industryContent.cards.map((card) => (
          <div
            ...
            } transition-all duration-300 ease-in-out md:hover:scale-105 cursor-pointer relative lg:float-animation text-center !items-center`}
            style={{
