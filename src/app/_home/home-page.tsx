...
const HomePage = () => {
  ...
  return (
    <>
      ...
      <StatsSection />
      <Industry />
      <Products products={products} hoveredProduct={hoveredProduct} setHoveredProduct={setHoveredProduct} />
      <IndustriesSection />
      <ModelGif currentProduct={currentProduct} hoveredProduct={hoveredProduct} />
    </>
  );
};
